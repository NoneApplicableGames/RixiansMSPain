...
public class AltArtListenerPatch
{
    ...
    { if (model != null && __instance.IsInsideTree()) NCardNeedsUpdateEvent[model] += __instance.Reload; }
    ...
    { if (model != null) NCardNeedsUpdateEvent[model] -= __instance.Reload; }
    ...
    { Arts.DoSafely(on: (__instance, power, amount), alt => alt.OnPowerApplied(__instance, choiceContext, power, amount)); }
    ...
    { Arts.DoSafely(on: (__instance, cardPlay.Card), alt => alt.OnCardPlayed(__instance, choiceContext, cardPlay)); }
    ...
    { Arts.DoSafely(on: (__instance, card), alt => alt.OnCardExhausted(__instance, choiceContext, card, causedByEthereal)); }
    ...
    { Arts.DoSafely(on: (__instance, card, creator), alt => alt.OnCardGenerated(__instance, card)); }
    ...
    { Arts.DoSafely(on: (__instance, creature), alt => alt.OnDeath(__instance, choiceContext, creature, wasRemovalPrevented)); }
    ...
    { Arts.DoSafely(on: (__instance, side), alt => alt.OnTurnEnd(__instance, choiceContext, side, participants)); }
    ...
    { Arts.DoSafely(on: (__instance, side), alt => alt.OnTurnStart(__instance, side, participants, combatState)); }
    ...
    { Arts.DoSafely(on: (__instance, card, fromHandDraw), alt => alt.OnCardDrawn(__instance, choiceContext, card, fromHandDraw)); }
    ...
    { Arts.DoSafely(on: (__instance, enchantment, amount), alt => alt.OnCardEnchanted(__instance, enchantment, amount)); }
